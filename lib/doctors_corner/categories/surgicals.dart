...
class doctors_surgicals extends StatefulWidget {
  String itemname, category;
  doctors_surgicals({Key? key, required this.itemname, required this.category})
      : super(key: key);

  @override
  State<doctors_surgicals> createState() => _doctors_surgicalsState();
}

class _doctors_surgicalsState extends State<doctors_surgicals> {
